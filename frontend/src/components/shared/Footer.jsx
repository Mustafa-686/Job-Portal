      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-2xl font-bold text-gray-800">Job <span className="text-blue-600">Hunt</span></h2>
            <p className="text-sm text-gray-500 mt-1">© 2025 Job Hunt. All rights reserved.</p>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-gray-500 hover:text-blue-500 transition">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-6 text-center text-sm text-gray-400">
          <p>
            <a href="/privacy-policy" className="hover:text-gray-600 transition">Privacy Policy</a> · <a href="/terms" className="hover:text-gray-600 transition">Terms of Service</a>
          </p>
        </div>
      </div>
    </footer>
